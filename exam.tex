...
%\item Нумерацию можно также перестроить.
    ...
    \subsection{Упрощаем формулу $\alpha$, сколемизация}
...
$$\begin{array}{ll}
    ...
    \begin{dfn}Система дизъюнктов $S = \{\delta_1,\dots,\delta_n\}$ Каждый δᵢ — дизъюнкт вида P₁ ∨ ¬P₂ ∨ ...
    \end{dfn}
    ...
    \subsection{Лямбда-исчисление, синтаксис}
    ...
    \subsection{Доказательство эквивалентности}
    ...
    \subsection{Типизация по Карри и Чёрчу}
